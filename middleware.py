###########################################
# THIS FILE WAS COPIED FROM THE FASTAPI-LIMITER REPOSITORY.
# The RateLimiterMiddleware is not yet available in the latest version (0.2.0),
# so I had to copy it from there and paste it here.
# Once it's available in the latest version,
# I can remove this file and import it from the package instead.
###########################################
